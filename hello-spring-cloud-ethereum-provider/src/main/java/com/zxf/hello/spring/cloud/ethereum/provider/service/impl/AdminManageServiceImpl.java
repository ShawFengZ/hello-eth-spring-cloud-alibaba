...
import com.zxf.hello.spring.cloud.ethereum.provider.common.HttpServiceEx;
import com.zxf.hello.spring.cloud.ethereum.provider.service.AdminManageService;
...
public class AdminManageServiceImpl implements AdminManageService {
    ...
    public String personalNewAccount(String password) throws IOException {
        //NewAccountIdentifier newAccountIdentifier = web3j.personalNewAccount(password).sendAsync();
        //web3j.shutdown();
