package com.zxf.hello.spring.cloud.ethereum.consumer.feign.service;

import com.zxf.hello.spring.cloud.ethereum.consumer.feign.service.fallback.ConnectServiceFallback;
import com.zxf.hello.spring.cloud.ethereum.consumer.feign.service.fallback.EthTransactionServiceFallback;
...
public interface EthTransactionService {
    ...
    public EthGetCode ethGetCode(@RequestParam("address") String address,
