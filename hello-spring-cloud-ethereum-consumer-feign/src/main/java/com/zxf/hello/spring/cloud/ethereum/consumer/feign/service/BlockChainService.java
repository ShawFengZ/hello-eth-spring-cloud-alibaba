...
import com.zxf.hello.spring.cloud.ethereum.consumer.feign.service.fallback.AdminManageServiceFallback;
import com.zxf.hello.spring.cloud.ethereum.consumer.feign.service.fallback.BlockChainServiceFallback;
